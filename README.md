...
We design SECure RAG, a framework designed to streamline financial data analysis through Agentic RAG. It leverages the power of LLMs to use structured and unstructured data sources with the help of retrievers and tools to retrieve data from a wide range of sources, each with large amounts of data, and then processes the data to answer a user query.
